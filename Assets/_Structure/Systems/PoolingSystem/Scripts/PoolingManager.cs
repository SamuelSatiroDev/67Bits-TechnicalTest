...
namespace RageMachine.PoolingSystem
{
    [CreateAssetMenu(fileName = "PoolingManager", menuName = "RageMachine/Tools/Pooling/Pooling Manager")]
    public sealed class PoolingManager : ScriptableSingleton<PoolingManager>
    {
        ...
        public void HandlerOnInitialize()
        {
            _poolingItems = new Dictionary<string, PoolingItem>();
        }
